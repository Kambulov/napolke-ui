      ...
      <SelectContext.Provider value={initialValue}>
        <div
          ...
          <style jsx>{`
            ...
            .select.active.icon,
            .select:hover .icon {
              color: ${disabled ? Theme.palette.gray500.name : borderActive};
            }
            ...
            .value {
              ...
              color: ${disabled ? Theme.palette.gray400 : Theme.palette.black};
            ...
            .icon {
              position: absolute;
              right: ${Theme.layout.gapQuarter.name};
              font-size: var(--select-font-size);
              top: 50%;
              bottom: 0;
...
SelectComponent.displayName = 'NuiSelect'
